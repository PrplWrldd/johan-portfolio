...
export const ms: TranslationDictionary = {
  ...
  hero: {
    ...
    badgeGovTech: 'Bekas Pelatih GovTech Malaysia',
  ...
  about: {
    ...
    currentInternshipTitle: 'GovTech Malaysia (Selesai)',
    currentInternshipRole: 'Bekas Pelatih Jurutera Keperluan & BA',
    currentInternshipText: 'Telah menggubal dan melengkapkan BRS, SRS, SDS, serta panduan pengguna bagi portal kerajaan berimpak nasional dan sistem kabinet di bawah Kementerian Digital.',
  ...
  experience: {
    ...
    overview: 'Bekas Pelatih Jurutera Keperluan / Penganalisis Perniagaan di GovTech Malaysia (Kementerian Digital), menggubal spesifikasi teknikal (SRS, SDS, BRS, serta Manual Pengguna) untuk platform awam.',
    ...
    items: [
      {
        ...
        role: 'Bekas Pelatih Jurutera Keperluan / Penganalisis Perniagaan',
        period: 'Mac – September 2026 (Selesai)',
