...
export const en: TranslationDictionary = {
  ...
  hero: {
    ...
    badgeGovTech: 'Former GovTech Malaysia Intern',
  ...
  about: {
    ...
    currentInternshipTitle: 'GovTech Malaysia (Completed)',
    currentInternshipRole: 'Former Requirements Engineer & BA Intern',
    currentInternshipText: 'Authored BRS, SRS, SDS, and user guides for national-scale government portals and cabinet systems at Kementerian Digital.',
  ...
  experience: {
    ...
    overview: 'Former Requirements Engineer / Business Analyst Intern at GovTech Malaysia (Kementerian Digital), authoring technical specifications (SRS, SDS, BRS, and User Guides) for national public sector platforms.',
    ...
    items: [
      {
        ...
        role: 'Former Requirements Engineer / Business Analyst Intern',
        period: 'March – September 2026 (Completed)',
